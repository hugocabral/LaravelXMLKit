<?php namespace hugocabral\LaravelXMLKit;
...
/**
 * LaravelXMLKit 1.0 by hugocabral
 *
 * Base functions for XML models
 */
abstract class LaravelXMLKit implements IteratorAggregate {
    ...
    /**
     * Create a new LaravelXMLKit model instance.
     *
     * @return LaravelXMLKit
     */
    ...
    protected function bootIfNotBooted() {
        ...
        if (!isset(static::$booted[$class])) {
            static::$path = Config::get('LaravelXMLKit.path', storage_path() . '/xml') . '/' . $this->file;
